...
const Blogdesign = ({val}) => {
  return (
    <div key={val.heading} className="bg-white group shadow-lg pb-6 flex flex-col gap-6  ">
    ...
    <div className="flex gap-2 items-center w-10/12 mx-auto justify-between ">
      <div className="flex items-center gap-3 ">
        ...
        <h4  className="text-xs font-bold text-ftpara">
          {val.admin}
        </h4>
      </div>
      ...
      <div className="flex items-center gap-3 ">
        ...
        <h4  className="text-customgreen flex text-xs font-bold text-ftpara">
          {val.comments}
        </h4>
      </div>
    </div>
    ...
    <div className="w-10/12 mx-auto">
      <h2  className="text-left group-hover:text-customgreen font-semibold text-2xl">
        {val.heading}
      </h2>
      <p  className="text-ftpara text-left mt-6">
        {val.parag}
      </p>
    </div>
  </div>
